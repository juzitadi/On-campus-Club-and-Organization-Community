	...
	<div class="container">
		<div class="gallery_gds w3l">
			...
			<ul class="simplefilter wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.1s">
                <li onclick="timeSort();" class="active" data-filter="all">Latest</li>
                <li  data-filter="1"><a href="showTicketActivities.jsp" class="menu__link">Tickets left</a></li>
     ...
     <section class="container page clearfix">
			...
			<form id="searchForm" name="searchForm" action="activities.jsp"  >
